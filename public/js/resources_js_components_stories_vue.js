...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    getteamMembersstories: function getteamMembersstories() {
      var _this = this;

      axios.get('/api/teamMembersstories').then(function (res) {
        if (res.data.success === true) _this.teamMembersstories = res.data.teamMembersstories;
      })["catch"](function (err) {
        console.log(err);
      });
    }
                  ...
                  _c(
                    ...
                    [
                      _c(
                        ...
                        _vm._l(
                          _vm.teamMembersstories,
                          function (teamMemberstories) {
                            return _c("div", { staticClass: "single-story" }, [
                              _c("div", { staticClass: "story-dp" }),
                              _vm._v(" "),
                              _c("div", { staticClass: "story-author" }, [
                                _c("p", { staticClass: "name" }, [
                                  _vm._v(_vm._s(teamMemberstories.name)),
                                ]),
                                _vm._v(" "),
                                _c("p", { staticClass: "time" }, [
                                  _vm._v(_vm._s(teamMemberstories.title)),
                                ]),
                              ]),
                            ])
                          }
