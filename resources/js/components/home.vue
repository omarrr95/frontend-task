...
<div class="row row-cols-1 row-cols-lg-2 row-cols-xl-4">
	<div class="col" v-for="teamMember in teamMembers">
		<div class="card radius-15">
			<div class="card-body text-center">
				<div class="p-4 border radius-15">
					<img :src="teamMember.avatar" width="110" height="110" class="rounded-circle shadow" alt="">
					<h5 class="mb-0 mt-5">{{ teamMember.name }}</h5>
					<p class="mb-3">{{ teamMember.title }}</p>
...
export default {
    ...
    methods: {
        getFeaturesList() {
          ...
          getteamMembers() {
            axios.get('/api/teamMembers').then(res => {
                if (res.data.success === true)
